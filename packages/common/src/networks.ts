...
srm: new PublicKey('49uPApDJo81q2ruSV7QGcKbWvrvidwkuwiBdNGqNLEDj'), msrm: new PublicKey('5WzVn4fzZwL1pHp3o1SnQwNhB6YjfinhQNZMRtv4PDRV'), god: new PublicKey('8WmKCQiuBo97cGE7NTo6Gvfec8fi9sMCwbdyToXk99eS'), megaGod: new PublicKey('4L6KRfJ2G1Gp59Cmav3Wux6wuyArvuhXx1R3ozCDF7Zy'), registryProgramId: new PublicKey( '7VA5eMqGwEvkkRsgrz28uFeqAKAMQ32TBHpTakKpWSBT', ), stakeProgramId: new PublicKey( 'FcznkS6Yo6mfhG6Rp49A5GTiag9AE9g8sZdfb5tUV271', ), lockupProgramId: new PublicKey( '9quusFhQuZPHTCWRNAiZspJtei639KNgmaJNFYUxbPwZ', ), retbufProgramId: new PublicKey( 'shmem4EWT2sPdVGvTZCzXXRAURL9G5vpPxNwSeKhHUL', ), metaEntityProgramId: new PublicKey( 'Ftm99ezozbjdSZJBU3raB316jdijGDWx1uSxRDwK2UUZ', ), registrar: new PublicKey('C8kZJRjMfQAC6Gjn8s25oHsDwQegMebWafDUBacmKCxR'), rewardEventQueue: new PublicKey('5a4WCYb4bPWJE7e8VGdr5ntUsapE6z9RBpc4Ci5CYfWn'), safe: new PublicKey('Gqhc69ywiiWTaLEJArC6pqHwzPCqGRmNMaiLUbsD5jqU'), retbuf: new PublicKey('7XxFAvQ9HoHch1jH1tJerPcAJ4zg65ZhusdMWeK5ZPx'), defaultEntity: new PublicKey( 'AX1XPYdcgiSrkKupNr8ywWFE1sNe6Ln79c5qyHGsRvju', ), }
};
